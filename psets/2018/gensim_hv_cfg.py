...
# with command line options: Configuration/GenProduction/python/hiddenValleyGridPack_darkphoton_m_10_ctau_1000_xiO_1.py --python_filename EXO-RunIIFall18wmLHEGS-04181_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:output.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(91) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 10
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(91)
