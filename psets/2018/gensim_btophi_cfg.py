...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/fragment.py nevts:200'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '6000211:all = GeneralResonance void 0 0 0 {mass} 0.001 0.0 0.0 {ctau}'.format(mass=mass, ctau=ctau), 
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.llphitomumukingenfilter)
