...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_higgs_m_15_ctau_100_xiO_2p5.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            '4900111:addChannel = 1 0.01 91 21 21', 
            '4900111:addChannel = 1 0.001 91 3 -3', 
            '4900111:addChannel = 1 0.121 91 4 -4', 
            '4900111:addChannel = 1 0.792 91 5 -5', 
            '4900111:addChannel = 1 0.076 91 15 -15', 
            '4900111:tau0 = 1000'),
