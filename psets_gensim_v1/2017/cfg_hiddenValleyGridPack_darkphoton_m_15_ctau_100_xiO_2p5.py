...
# with command line options: Configuration/GenProduction/python/hiddenValleyGridPack_darkphoton_m_15_ctau_100_xiO_2p5.py --python_filename cfg_hiddenValleyGridPack_darkphoton_m_15_ctau_100_xiO_2p5.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:EXO-RunIIFall17wmLHEGS-04157.root --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_darkphoton_m_15_ctau_100_xiO_2p5.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIIFall17wmLHEGS-04157.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            'HiddenValley:Lambda = 15.0', 
            'HiddenValley:pTminFSR = 16.5', 
            'HiddenValley:spinFv=0', 
            '4900101:m0 = 6.0', 
            '4900111:m0 = 15', 
            '4900113:m0 = 37.5', 
            '999999:all = GeneralResonance void 1 0 0 6.0 0.001 0. 0. 0.', 
            '4900113:addChannel = 1 1.0 91 4900111 4900111', 
            '4900111:addChannel = 1 1.0 91 999999 999999', 
            '999999:addChannel = 1 0.05 91 1 -1', 
            '999999:addChannel = 1 0.2 91 2 -2', 
            '999999:addChannel = 1 0.05 91 3 -3', 
            '999999:addChannel = 1 0.2 91 4 -4', 
            '999999:addChannel = 1 0.048 91 5 -5', 
            '999999:addChannel = 1 0.15 91 11 -11', 
            '999999:addChannel = 1 0.15 91 13 -13', 
            '999999:addChannel = 1 0.15 91 15 -15', 
            '999999:tau0 = 1000'),
...
process.genfilter = cms.EDFilter("GenParticleSelector",
    cut = cms.string('(pdgId==25) && pt>140. && isLastCopy()'),
