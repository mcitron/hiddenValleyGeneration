...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_vector_m_5_ctau_1000_xiO_1.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            '4900111:m0 = 5', 
            '4900113:m0 = 5.0', 
            '4900113:addChannel = 1 0.054 91 1 -1', 
            '4900113:addChannel = 1 0.216 91 2 -2', 
            '4900113:addChannel = 1 0.054 91 3 -3', 
            '4900113:addChannel = 1 0.209 91 4 -4', 
            '4900113:addChannel = 1 0.162 91 11 -11', 
            '4900113:addChannel = 1 0.162 91 13 -13', 
            '4900113:addChannel = 1 0.143 91 15 -15', 
            '4900113:tau0 = 10000', 
            '4900111:onMode = 0'),
