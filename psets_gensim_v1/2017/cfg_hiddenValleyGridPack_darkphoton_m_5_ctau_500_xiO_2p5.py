...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_darkphoton_m_5_ctau_500_xiO_2p5.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            '4900111:m0 = 5', 
            '4900113:m0 = 12.5', 
            '999999:all = GeneralResonance void 1 0 0 2.0 0.001 0. 0. 0.', 
            '4900113:addChannel = 1 1.0 91 4900111 4900111', 
            '4900111:addChannel = 1 1.0 91 999999 999999', 
            '999999:addChannel = 1 0.054 91 1 -1', 
            '999999:addChannel = 1 0.216 91 2 -2', 
            '999999:addChannel = 1 0.054 91 3 -3', 
            '999999:addChannel = 1 0.209 91 4 -4', 
            '999999:addChannel = 1 0.162 91 11 -11', 
            '999999:addChannel = 1 0.162 91 13 -13', 
            '999999:addChannel = 1 0.143 91 15 -15', 
            '999999:tau0 = 5000'),
