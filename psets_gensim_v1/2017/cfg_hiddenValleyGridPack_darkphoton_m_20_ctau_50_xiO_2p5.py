...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_darkphoton_m_20_ctau_50_xiO_2p5.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            'HiddenValley:Lambda = 20.0', 
            'HiddenValley:pTminFSR = 22.0', 
            'HiddenValley:spinFv=0', 
            '4900101:m0 = 8.0', 
            '4900111:m0 = 20', 
            '4900113:m0 = 50.0', 
            '999999:all = GeneralResonance void 1 0 0 8.0 0.001 0. 0. 0.', 
            ...
            '999999:addChannel = 1 0.049 91 5 -5', 
