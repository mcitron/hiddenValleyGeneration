...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_higgs_m_20_ctau_50_xiO_2p5.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            '4900111:addChannel = 1 0.007 91 21 21', 
            '4900111:addChannel = 1 0.001 91 3 -3', 
            '4900111:addChannel = 1 0.101 91 4 -4', 
            '4900111:addChannel = 1 0.828 91 5 -5', 
            '4900111:addChannel = 1 0.063 91 15 -15', 
            '4900111:tau0 = 500'),
