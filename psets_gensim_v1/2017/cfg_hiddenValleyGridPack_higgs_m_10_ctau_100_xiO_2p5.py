...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_higgs_m_10_ctau_100_xiO_2p5.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            '4900111:addChannel = 1 0.021 91 21 21', 
            '4900111:addChannel = 1 0.002 91 3 -3', 
            '4900111:addChannel = 1 0.262 91 4 -4', 
            '4900111:addChannel = 1 0.548 91 5 -5', 
            '4900111:addChannel = 1 0.001 91 13 -13', 
            '4900111:addChannel = 1 0.167 91 15 -15', 
            '4900111:tau0 = 1000'),
