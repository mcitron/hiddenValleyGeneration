...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/hiddenValleyGridPack_higgs_m_4_ctau_100_xiO_2p5.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            ...
            '4900111:addChannel = 1 0.169 91 21 21', 
            '4900111:addChannel = 1 0.036 91 3 -3', 
            '4900111:addChannel = 1 0.332 91 4 -4', 
            '4900111:addChannel = 1 0.016 91 13 -13', 
            '4900111:addChannel = 1 0.446 91 15 -15', 
            '4900111:tau0 = 1000'),
