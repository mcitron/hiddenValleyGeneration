...
# with command line options: Configuration/GenProduction/python/cfgs_update_noFilter/hiddenValleyGridPack_darkphoton_m_15_ctau_500_xiO_2p5.py --python_filename cfg_hiddenValleyGridPack_darkphoton_m_15_ctau_500_xiO_2p5.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:output.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(0) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/cfgs_update_noFilter/hiddenValleyGridPack_darkphoton_m_15_ctau_500_xiO_2p5.py nevts:10'),
