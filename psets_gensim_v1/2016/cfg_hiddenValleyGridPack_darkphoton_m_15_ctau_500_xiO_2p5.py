...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/cfgs_update_filter_2016/hiddenValleyGridPack_darkphoton_m_15_ctau_500_xiO_2p5.py nevts:10'),
