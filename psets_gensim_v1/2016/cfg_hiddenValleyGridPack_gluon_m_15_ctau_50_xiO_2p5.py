...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/cfgs_update_filter_2016/hiddenValleyGridPack_gluon_m_15_ctau_50_xiO_2p5.py nevts:10'),
